    ...
    hooks: {
        ...
        beforeChange: [
            ...
            function (args) { return __awaiter(void 0, void 0, void 0, function () {
                var productData, stripeProduct, stripePrice, data, updatedProduct, updated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            stripePrice = _a.sent();
                            return [2 /*return*/, __assign(__assign({}, productData), { stripeId: stripeProduct.id, priceId: stripePrice.id })];
                        case 3:
